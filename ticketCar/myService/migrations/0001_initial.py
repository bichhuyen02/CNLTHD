# Generated by Django 5.0.4 on 2024-04-11 02:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('role', models.CharField(choices=[('Customer', 'Customer'), ('Driver', 'Driver'), ('Staff', 'Staff')], default='Customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField()),
                ('departure', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trip_departure', to='myService.bstation')),
                ('destination', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trip_destination', to='myService.bstation')),
