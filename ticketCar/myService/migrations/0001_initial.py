    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_cate', models.CharField(blank=True, choices=[('Lễ_Ghế', 'Lễ_Ghế'), ('Lễ_Giường', 'Lễ_Giường'), ('Thường_Ghế', 'Thường_Ghế'), ('Thường_Giường', 'Thường_Giường')], default='Lễ_Ghế', max_length=50)),
            ],
            options={
                'ordering': ['id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('active', models.BooleanField(default=True)),
                ('bStation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myService.bstation')),
        ...
        migrations.AddField(
            model_name='bstation',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myService.province'),
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
